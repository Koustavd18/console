...
const Stream: FC = () => {
	...
	const { getStreamInfoRefetch, getStreamInfoLoading, getStreamInfoRefetching } = useGetStreamInfo(currentStream || '');
	...
	const isInfoLoading = (getStreamInfoLoading || getStreamInfoRefetching) && view === 'explore';
